...
//   signIn end
  ...
  return (
    <div className="w-full max-w-md p-8 space-y-3 rounded-xl mx-auto mt-10 border-2 border-[#4D869C] ">
      ...
      <form onSubmit={handleSignIn} className="space-y-6">
        ...
        <button type="submit" className="block w-full p-3 text-center rounded-sm text-white bg-[#4D869C]">
          Sign in
        </button>
      </form>
